const common = {
  ...
  'common.messages': '{{count}} messages',
	...
	'common.logId': 'Log ID',
  'common.backendUnavailable.title': 'Unable to connect to Denova',
  'common.backendUnavailable.description': 'Check this device’s network and the connection to the device running Denova, then try again.',
