const editor = {
  ...
  'editor.save': 'Save',
  'editor.revealChapterInOutlineTooltip': 'Reveal the current chapter in the book outline',
  ...
  'editor.orphaned.title': 'File deleted from disk',
  'editor.orphaned.description': 'The editor content is retained and Auto Save is paused. Saving manually recreates the file.',
  'editor.orphaned.readOnlyDescription': 'The last loaded content is retained here and will sync automatically if the file reappears.',
  'editor.quoteSelection': 'Quote to AI',
  'editor.quoteSelectionShortcut': 'Quote to AI (⌘⇧L)',
  'editor.review.comment': 'Text comment',
  ...
  'editor.review.expandComment': 'Expand comment',
  'editor.review.collapseComment': 'Collapse comment',
  'editor.review.outdated': 'Source text changed',
  'editor.review.prepareFailed': 'Could not add the comment. Make sure the content is saved and has not changed elsewhere, then try again.',
  'editor.review.createFailed': 'Could not add the comment',
  'editor.review.updateFailed': 'Could not update the comment',
  'editor.review.deleteFailed': 'Could not delete the comment',
