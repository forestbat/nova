const editor = {
  ...
  'editor.save': '保存',
  'editor.revealChapterInOutlineTooltip': '在作品目录中显示当前章节',
  ...
  'editor.mode.label': '编辑模式',
  'editor.mode.document': '文档',
  ...
  'editor.orphaned.title': '文件已从磁盘删除',
  'editor.orphaned.description': '已保留编辑器中的内容并暂停自动保存；手动保存会重新创建此文件。',
  'editor.orphaned.readOnlyDescription': '这里保留最后一次载入的内容；文件重新出现后会自动同步。',
  'editor.quoteSelection': '引用到 AI',
  'editor.quoteSelectionShortcut': '引用到 AI (⌘⇧L)',
  'editor.review.comment': '文本评论',
  'editor.review.addComment': '添加评论',
  'editor.review.commentSelection': '评论选中内容 (⌘⇧L)',
  'editor.review.commentCurrentLine': '评论当前行',
  'editor.review.expandComment': '展开评论',
  'editor.review.collapseComment': '折叠评论',
  'editor.review.outdated': '原文已变化',
  'editor.review.prepareFailed': '无法添加评论，请确认内容已保存且未被外部修改后重试',
  'editor.review.createFailed': '添加评论失败',
  'editor.review.updateFailed': '更新评论失败',
  'editor.review.deleteFailed': '删除评论失败',
